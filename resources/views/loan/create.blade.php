...
<div class="container-xxl container-p-y">
    <h1 class="h3 mb-3"><strong>Tambah Pinjaman</strong></h1>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('loan.store') }}" method="POST" id="form-loan">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="tenor" id="tenor" class="form-control" min="1">
                </div>

                {{-- Info --}}
                <div class="mb-3">
                    <label>Estimasi Cicilan / Bulan</label>
                    <input type="text" id="installment_preview" class="form-control" readonly>
                </div>
