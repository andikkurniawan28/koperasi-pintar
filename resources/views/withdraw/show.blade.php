    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between mb-4">
                <div>
                    <h3 class="mb-1"><strong>Penarikan Simpanan</strong></h3>
            ...
            <div class="table-responsive mb-4">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>{{ $withdraw->savingType->name }}</td>
                    </tr>
                    <tr>
                        <th>Total Penarikan</th>
                        <td><strong>{{ number_format($withdraw->total,0,',','.') }}</strong></td>
                    </tr>
                    <tr>
                        <th>Penarikan Lewat</th>
                        <td>{{ $withdraw->account->code }}-{{ $withdraw->account->name }}</td>
                    </tr>
                </table>
            </div>
