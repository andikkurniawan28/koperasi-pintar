...
<div class="container-xxl flex-grow-1 container-p-y">
    <h1 class="h3 mb-3"><strong>Tambah Jenis Pinjaman</strong></h1>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('loan_type.store') }}" method="POST" id="form-loan">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="interest_type" class="form-control" required>
                        ...
                        <option value="effective" {{ old('interest_type') == 'effective' ? 'selected' : '' }}>Efektif</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" step="0.01" name="max_amount" class="form-control rupiah"
                ...
                <div class="mb-3">
                    ...
                    <select name="requires_collateral" class="form-control" required>
                        <option value="0" {{ old('requires_collateral') == '0' ? 'selected' : '' }}>Tidak</option>
                        <option value="1" {{ old('requires_collateral') == '1' ? 'selected' : '' }}>Ya</option>
                    </select>
                </div>
