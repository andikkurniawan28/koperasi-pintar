...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h1 class="h3 mb-3"><strong>Tambah Tagihan</strong></h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('invoice.store') }}" method="POST">
                    ...
                    <table class="table table-binvoiceed" id="items-table">
                        <thead>
                            <tr>
                                <th>Nama</th>
                                <th>Keterangan</th>
...
$(function() {
    ...
    $('#add-row').click(function() {
        ...
        <tr>
            ...
            <td>
                <textarea name="items[${index}][description]" class="form-control" requuired></textarea>
            </td>
            <td>
                <input type="text" name="items[${index}][amount]" class="form-control price">
            </td>
            <td>
